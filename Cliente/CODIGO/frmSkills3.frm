...
'Image1.Picture = LoadPicture(App.Path & "\Data\GRAFICOS\Botónok.jpg")
...
For i = 0 To NUMSKILLS * 2 - 1
    If i Mod 2 = 0 Then
       ' command1(i).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\BotónMás.jpg")
    Else
      '  command1(i).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\BotónMenos.jpg")
    End If
Next

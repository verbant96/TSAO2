...
'Image1(2).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\bteclas.jpg")
...
Select Case Index
    Case 0
        If Image1(0).Tag = "0" Then
            ...
            Image1(0).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\bsiguientea.jpg")
        End If
    Case 1
        If Image1(1).Tag = "0" Then
            ...
            Image1(1).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(1).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\bvolvera.jpg")
        End If
    Case 2
        If Image1(2).Tag = "0" Then
            ...
            Image1(2).Tag = "1"
            Call Audio.PlayWave(SND_OVER)
            Image1(2).Picture = LoadPicture(App.Path & "\Data\GRAFICOS\bteclasa.jpg")
        End If
